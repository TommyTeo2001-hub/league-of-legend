...
export default function CommentsSection({ championId }: SectionProps) {
  ...
  const fetchComments = async (pageNum = 1) => {
    ...
    try {
      // Sử dụng API chung cho comments với type=tft-champion và ID là slug của tướng
      const response = await fetch(`/api/comments?type=tft-champion&id=${slug}&page=${pageNum}&limit=10`)
  ...
  return (
    <div className="bg-[#121214] border border-[#2a2a30] rounded-xl p-6" ref={commentRef}>
      ...
      <div className="mb-8">
        <Textarea
          placeholder="Chia sẻ suy nghĩ của bạn về tướng này..."
          value={newComment}
