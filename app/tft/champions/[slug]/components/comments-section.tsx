...
const demoComments: Comment[] = [
  {
    id: 1,
    content: "This champion is really strong in the current meta. Try pairing with other Freljord champions for maximum effect.",
    ...
    replies: [
      {
        id: 2,
        content: "Agreed! The Shapeshifter trait is also really powerful right now.",
  ...
  {
    id: 3,
    content: "Best items for this champion are Bloodthirster and Giant's Belt. The extra survivability makes a huge difference.",
...
export default function CommentsSection() {
  ...
  return (
    <div className="bg-[#121214] border border-[#2a2a30] rounded-xl p-6">
      ...
      <div className="mb-8">
        <Textarea
          placeholder="Share your thoughts about this champion..."
          value={newComment}
